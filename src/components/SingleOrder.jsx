...
const SingleOrder = () => {
  ...
  const user = useSelector(state=>state.users.users.find(user=>user._id === order.userId))
        ...
        <div className="flex ">
          ...
          <div className="flex-1 mx-6 shadow-md bg-gray-50">
            ...
            <div className="flex flex-col">
              ...
              <div className=" flex justify-evenly items-center text-md font-bold mx-8 my-8">
                  <div className="pl-9 pb-6">
                    <h2 className="text-xl text-gray-300 font-bold pb-4">Status</h2>
                    <select className="border-b-2 outline-none w-60 text-gray-600 font-semibold text-lg" type="text" name="status" onChange={ handleChange}>
                    <option value="accepted">Accept</option>
                    <option value="declined">Decline</option>
                    <option value="delivered">Delivered</option>
                    </select>
                    </div>
                <button className="w-20 h-10 bg-green-400 text-white shadow-sm hover:shadow-md p-2 rounded-lg" onClick={handleAccept} >Update</button>
              </div>
